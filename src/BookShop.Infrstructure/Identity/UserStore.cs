...
namespace BookShop.Infrastructure.Identity
{
...

    {
        ...
        public UserStore(IUserRepository userRepository, ICurrentUser currentUser, IUserTokenRepository userTokenRepository)
        {
        ...
        {
            UserToken? userToken = await _userTokenRepository.GetOrDefaultAsync(name , loginProvider);
        ...
        public async Task SetTokenAsync(User user, string loginProvider, string name, string? value, CancellationToken cancellationToken)
        {
            ...
            if(userToken == null)
            {
                await _userTokenRepository.Add(new UserToken
                {
