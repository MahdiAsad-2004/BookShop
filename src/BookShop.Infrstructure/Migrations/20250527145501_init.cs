        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    UserId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    TrackingCode = table.Column<string>(type: "VarChar(50)", nullable: true),
                    UsedDiscountCode = table.Column<string>(type: "VarChar(50)", nullable: true),
                    EstimatedDeliveryDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    PackWeight = table.Column<float>(type: "real", nullable: false),
                    DiscountPrice = table.Column<int>(type: "int", nullable: false),
                    DeliveryPrice = table.Column<int>(type: "int", nullable: false),
                    ProductPriceSummary = table.Column<int>(type: "int", nullable: false),
                    TotlaPrice = table.Column<int>(type: "int", nullable: false),
                    CreateDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    LastModifiedDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CreateBy = table.Column<string>(type: "VarChar(36)", nullable: false),
                    LastModifiedBy = table.Column<string>(type: "VarChar(36)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    Quantity = table.Column<int>(type: "int", nullable: false),
                    Product_Title = table.Column<string>(type: "NVarChar(50)", nullable: false),
                    Product_Price = table.Column<int>(type: "int", nullable: false),
                    Product_PurchasePrice = table.Column<int>(type: "int", nullable: false),
                    ProductId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
