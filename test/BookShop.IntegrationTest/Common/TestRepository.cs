...
namespace BookShop.IntegrationTest.Common
{
    public class TestRepository
    {
        ...
        public TestRepository(IServiceScopeFactory serviceScopeFactory)
        {
        ...
        public async Task AddPermissionForUser(string permissionName)
        {
            using var scope = _serviceScopeFactory.CreateScope();
            _bookShopDbContext = scope.ServiceProvider.GetRequiredService<BookShopDbContext>();
        ...
        public async Task AddPermissionForUser(params string[] permissionNames)
        {
            using var scope = _serviceScopeFactory.CreateScope();
            _bookShopDbContext = scope.ServiceProvider.GetRequiredService<BookShopDbContext>();
